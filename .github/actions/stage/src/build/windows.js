...
class WindowsBuilder {
    ...
    async runBuild() {
        ...
        if (this.buildType === 'Release') {
            ...
            buildArgs = ['run', 'build', 'Release', '--', '--target_arch=' + this.arch, '--target=create_dist', '--skip_signing', '--ninja', `j:6`, '--gn', 'symbol_level:0', '--gn', 'blink_symbol_level:0', '--gn', 'v8_symbol_level:0', '--gn', 'should_generate_symbols:false'];
            ...
            console.log('Note: Disabled should_generate_symbols to skip Windows PDB symbol generation');
        } else {
