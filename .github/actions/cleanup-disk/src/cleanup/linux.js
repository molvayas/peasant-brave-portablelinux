...
class LinuxCleanup {
    constructor() {
        this.buildDirLocation = '/home/runner';
    }
    ...
    async run() {
        console.log('=== Runner Disk Space Cleanup (Linux) ===');
        ...
        const cleanupDirs = [
            ...
            {path: '/opt/hostedtoolcache/go/1.22.12', name: 'Go 1.22.12'},
